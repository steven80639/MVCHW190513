namespace HW190512.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶數量明細Repository Get客戶數量明細Repository()
		{
			var repository = new 客戶數量明細Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶數量明細Repository Get客戶數量明細Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶數量明細Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
